...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidgetNodeTree = QtWidgets.QDockWidget(MainWindow)
        self.dockWidgetNodeTree.setEnabled(True)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/resources/history.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dockWidgetNodeTree.setWindowIcon(icon1)
        self.dockWidgetNodeTree.setObjectName("dockWidgetNodeTree")
        self.dockWidgetNodes = QtWidgets.QWidget()
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dockWidgetNodes.sizePolicy().hasHeightForWidth())
        self.dockWidgetNodes.setSizePolicy(sizePolicy)
        self.dockWidgetNodes.setObjectName("dockWidgetNodes")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.dockWidgetNodes)
        self.gridLayout_7.setSpacing(1)
        self.gridLayout_7.setContentsMargins(1, 1, 1, 1)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.dockWidgetNodeTree.setWidget(self.dockWidgetNodes)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(1), self.dockWidgetNodeTree)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/resources/colors_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEdit_Theme.setIcon(icon17)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dockWidgetNodeTree.setWindowTitle(QtCompat.translate("MainWindow", "Nodes", None, -1))
        ...
        self.actionEdit_Theme.setText(QtCompat.translate("MainWindow", "Edit Theme", None, -1))
